 ...
 * 	  2) 매개변수의 타입 생략
 * 		(a)->{구현}
 * 	  3) 매개변수가 1개인 경우 -> 괄호 생략
 * 		 a->{구현}
 * 	  4) 구현의 {} 생략이 가능
 * 		 a->System.out.printla(a)
 * 	---------------------------------------------
 * 	 리턴형이 있는 경우
 * 	 (x,y) -> {return x+y}
 * 	 리턴이 생략된 경우
 ...
 */
public class 람다_1 {
	static 계산기 add=(a,b)->System.out.println(a+b);
	static 계산기 minus=(a,b)->System.out.println(a-b);
	static 계산기 gob=(a,b)->System.out.println(a*b);
	static 계산기 div=(a,b)->System.out.println(a/b);
