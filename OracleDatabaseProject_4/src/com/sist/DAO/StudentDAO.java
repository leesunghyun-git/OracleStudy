...
public class StudentDAO {
	...
	public List<StudentVO> stdAllData()
	{
		...
		try
		{
			...
			String sql="SELECT hakbun,name,kor,eng,math,kor+eng+math,ROUND((kor,eng,math)/3.0,2) FROM student";
	...
	public void stdInsert(StudentVO vo)
	{
		...
		{
			conn=db.getConnection();
			String sql="INSERT INTO student(hakbun,name,kor,eng,math) VALUES((SELECT NVL(MAX(hakbun)+1,1) FROM student +"
					+ "?,?,?,?)";
			// SQL Injection	
